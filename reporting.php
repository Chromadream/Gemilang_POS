    ...
    <table class="table table-inverse table-responsive">
          <tbody>
            <tr>
              ...
              <td><input type="date" id="dailypicker" /><button type="button" class="btn btn-secondary btn-sm" onclick="dailyreportwrapper();">Submit</button></td>
              <td><div id="daily_sum"></div></td>
            </tr>
            <tr>
              <td scope="row">Bulanan</td>
              <td><div id="monthreporting"></div><button type="button" class="btn btn-secondary btn-sm" onclick="monthlyreportwrapper();">Submit</button></td>
              <td><div id="monthly_sum"></div></td>
            </tr>
            <tr>
              <td scope="row">Tahunan</td>
              <td><div id="yearreporting"></div><button type="button" class="btn btn-secondary btn-sm" onclick="yearlyreportwrapper();">Submit</button></td>
