            ...
            <tbody>
                ...
                for($i=0;$i<$items->rowCount();$i++)
                {
                    ...
                    <td><div class="form-group">
                      <input type="number" class="form-control" id="price<?php echo $current_item->product_id;?>" value="<?php echo formatting($current_price);?>" onchange="change_price(<?php echo $current_item->product_id;?>,<?php echo $id;?>)">
                    </div></td>
