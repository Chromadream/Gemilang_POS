            ...
            <tbody>
                ...
                for($i=0;$i<$items->rowCount();$i++)
                {
                    ...
                    <td><div class="form-group">
                      <input type="number" class="form-control" id="price<?php echo $current_item->product_id;?>" value="<?php echo $current_price;?>" onchange="change_price(<?php echo $current_item->product_id;?>,<?php echo $id;?>)">
                    </div></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Total akhir</td>
                    <td><?php $total = $subtotal_price*$price_percentage;$transaction_DAO->update_transaction_total($id,$total);echo formatting($total);?></td>
                </tr>
            </tbody>
        </table>
    </div>
